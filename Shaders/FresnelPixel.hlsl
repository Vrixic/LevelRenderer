...
float Fresnel(float start, float end, float normalDotView)
{
...
float4 main(PixelIn input) : SV_TARGET
{
    ...
    float4 Color = float4(FresnelColor, 1.0f) * Fresnel(0, 1, dot(SurfaceNormal, ViewDirection));
    
    float Alpha = 1.0f;
    return Color * Alpha;
}

//float Fresnel(float normalDotView)
//{
//    return pow((1.0f - normalDotView), 2);
//}
...
//    float4 Color = float4(0.0f, 1.0f, 1.0f, 1.0f) * Fresnel(dot(SurfaceNormal, ViewDirection));    
//    return Color;
//}